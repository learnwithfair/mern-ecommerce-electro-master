              ...
              <div className="card-body py-0 px-0 px-sm-3">
                <div className="row align-items-center">
                  <div className="col-4 col-sm-3 col-xl-2">
                    <img
                      src="src/backend/assets/images/dashboard/Group126@2x.png"
                  ...
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <img
                            src="src/backend/assets/images/faces/face1.jpg"
                            alt="image"
                          />
                      ...
                      <tr>
                        ...
                        <td>
                          <img
                            src="src/backend/assets/images/faces/face5.jpg"
                            alt="image"
                          />
              ...
              <div className="card-body">
                ...
                <div className="preview-list">
                  <div className="preview-item border-bottom">
                    <div className="preview-thumbnail">
                      <img
                        src="src/backend/assets/images/faces/face6.jpg"
                        alt="image"
                  ...
                  <div className="preview-item border-bottom">
                    <div className="preview-thumbnail">
                      <img
                        src="src/backend/assets/images/faces/face8.jpg"
                        alt="image"
                        className="rounded-circle"
                      />
                    </div>
                  ...
                  <div className="preview-item border-bottom">
                    <div className="preview-thumbnail">
                      <img
                        src="src/backend/assets/images/faces/face9.jpg"
                        alt="image"
                        className="rounded-circle"
                      />
                    </div>
                  ...
                  <div className="preview-item border-bottom">
                    <div className="preview-thumbnail">
                      <img
                        src="src/backend/assets/images/faces/face11.jpg"
                        alt="image"
                        className="rounded-circle"
                      />
                    </div>
            ...
            <div className="card">
              <div className="card-body">
                ...
                >
                  <div className="item">
                    <img
                      src="src/backend/assets/images/dashboard/Rectangle.jpg"
                      alt="/"
                    />
                  </div>
                  <div className="item">
                    <img
                      src="src/backend/assets/images/dashboard/Img_5.jpg"
                      alt=""
                    />
                  </div>
                  <div className="item">
                    <img
                      src="src/backend/assets/images/dashboard/img_6.jpg"
                      alt="/"
                    />
                  </div>
                </div>
                <div className="d-flex py-4">
                  <div className="preview-list w-100">
                    <div className="preview-item p-0">
                      <div className="preview-thumbnail">
                        <img
                          src="src/backend/assets/images/faces/face12.jpg"
                          className="rounded-circle"
                          alt=""
                        />
                      </div>
